            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="addr" class="col-md-4 col-form-label text-md-right">{{ __('Addr') }}</label>

                            <div class="col-md-6">
                                <input id="addr" type="text" class="form-control @error('addr') is-invalid @enderror" name="addr" value="{{ old('addr') }}" autocomplete="addr" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Phone(+380)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="phone_auth" class="col-md-4 col-form-label text-md-right">{{ __('Phone auth') }}</label>

                            <div class="col-md-6">
                                <input id="phone_auth" type="number" class="form-control @error('phone_auth') is-invalid @enderror" name="phone_auth" value="{{ old('phone_auth') }}" autocomplete="phone_auth" autofocus>
